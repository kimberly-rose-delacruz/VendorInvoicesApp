    ...
    public class VendorService : IVendorService
    {
        ...
        public ICollection<Vendor> GetAllVendorsByGroupLink(int selectedGroupLink)
        {
            if (selectedGroupLink == 1)
            {
                ...
                || v.Name.StartsWith("b") || v.Name.StartsWith("C") || v.Name.StartsWith("c") || v.Name.StartsWith("D") || v.Name.StartsWith("d") || v.Name.StartsWith("e") || v.Name.StartsWith("E")).OrderBy(v=>v.Name).ToList();
            }
            if (selectedGroupLink == 2)
            {
                ...
                || v.Name.StartsWith("G") || v.Name.StartsWith("H") || v.Name.StartsWith("h") || v.Name.StartsWith("i") || v.Name.StartsWith("I") || v.Name.StartsWith("J") || v.Name.StartsWith("j") || v.Name.StartsWith("K") || v.Name.StartsWith("k")).OrderBy(v => v.Name).ToList();
            }
            if (selectedGroupLink == 3)
            {
                ...
                || v.Name.StartsWith("M") || v.Name.StartsWith("n") || v.Name.StartsWith("N") || v.Name.StartsWith("O") || v.Name.StartsWith("o") || v.Name.StartsWith("P") || v.Name.StartsWith("p") || v.Name.StartsWith("Q") || v.Name.StartsWith("q") || v.Name.StartsWith("R") || v.Name.StartsWith("r")).OrderBy(v => v.Name).ToList();
            }
            if (selectedGroupLink == 4)
            {
                ...
                || v.Name.StartsWith("t") || v.Name.StartsWith("U") || v.Name.StartsWith("u") || v.Name.StartsWith("V") || v.Name.StartsWith("v") || v.Name.StartsWith("W") || v.Name.StartsWith("w") || v.Name.StartsWith("x") || v.Name.StartsWith("X") || v.Name.StartsWith("Y") || v.Name.StartsWith("y") || v.Name.StartsWith("z") || v.Name.StartsWith("Z")).OrderBy(v => v.Name).ToList();
            }
